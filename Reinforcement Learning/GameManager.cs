				...
				else
				{
					...
					else
					{
						...
						if(playerforNextTurn == GamePlayer.DynamicProgramming)
							...
							gameMove = MainProgram.SarsaValueFunctionManager.GetNextMove(gameState.BoardStateKey);
			...
			while (true)
			{
				...
				switch (Console.ReadLine())
				{
					case "1":
						...
						break;
					case "2":
						if (MainProgram.SarsaValueFunctionManager.ActionValueFunction.Count > 0)
						{
